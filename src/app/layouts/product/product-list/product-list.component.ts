...
export class ProductListComponent implements OnInit {
	...
	showPromo(){
		...
		this.toastrService.info('this marketing promotion has been added', 'adding');
}
	...
	*/
	...
	addCuponMarketing(product: Product) {
		let myNewproduct :  any = new Object();
		...
		this.marketingService.createCuponMarketing(myNewproduct);
